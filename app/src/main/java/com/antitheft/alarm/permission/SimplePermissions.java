...
public final class SimplePermissions {
    ...
    private SimplePermissions(Activity activity) {
        mActivity = activity;
    }
     ...
     * 设置请求的对象
     */
    public static SimplePermissions with(Activity activity) {
     ...
     * 设置权限组
     */
    public SimplePermissions permission(String... permissions) {
     ...
     * 设置权限组
     */
    public SimplePermissions permission(List<String> permissions) {
     ...
     * 被拒绝后继续申请，直到授权或者永久拒绝
     */
    public SimplePermissions constantRequest() {
        mConstant = true;
        return this;
    }
